...
* Open a GitHub [enhancement request issue](https://github.com/SolaceLabs/solace-azure-quickstart-template/issues/new) and describe the new functionality.
